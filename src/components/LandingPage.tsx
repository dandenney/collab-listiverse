...
import { ShoppingCart, BookOpen, Film, MapPin, ShoppingBag, UtensilsCrossed } from "lucide-react";
...
export function LandingPage() {
  return <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="grid gap-4 grid-cols-2 md:grid-cols-2 lg:grid-cols-3">
        {sections.map((section, index) => <motion.div key={section.path} initial={{
        opacity: 0,
        y: 20
      }} animate={{
        opacity: 1,
        ...
        delay: index * 0.1
            ...
            <Link to={section.path} className="block p-4 md:p-6 rounded-lg border border-border hover:border-primary transition-colors bg-card hover:bg-card/80">
